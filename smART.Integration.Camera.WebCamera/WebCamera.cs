...
{
    public class WebCamera : IPCamera
    {
        public WebCamera(string baseURL, string username, string password, string snapShotURL, string zoomURL, string panTiltURL, string cameraID)
            : base(baseURL, username, password, snapShotURL, zoomURL, panTiltURL, cameraID)
        { }

        public WebCamera(string baseURL, string username, string password)
            : base(baseURL, username, password, "jpg/image.cgi", "com/ptz.cgi", "com/ptz.cgi", "1")
        { }

        public WebCamera(string baseURL)
