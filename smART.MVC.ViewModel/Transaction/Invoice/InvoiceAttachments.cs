...
{
    public class InvoiceAttachments : AttachmentEntity<Invoice>
    {
        //[Required]
        ...
        //[ClientTemplateHtml("<a target='blank' href='/../InvoiceAttachments/OpenDocument?id=<#= Document_RefId #>'><#= Document_Title #></a>")]
        //public override string Document_Title { get; set; }

        public InvoiceAttachments()
        {
            ControllerName = "InvoiceAttachments";        
        }
    }
}
