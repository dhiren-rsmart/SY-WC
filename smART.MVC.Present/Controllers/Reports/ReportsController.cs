...
namespace smART.MVC.Present.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        {
            smART.ViewModel.Booking booking = new smART.Library.BookingLibrary(smART.Common.ConfigurationHelper.GetsmARTDBContextConnectionString()).GetByID(ID);
        ...
        [HttpGet]
        public ActionResult QScale(String ID)
        {
            ViewBag.ID = ID;
            return View("QScaleReceiveTicket");
        }
        ...
        {
            ViewBag.ID = ID;
            smART.ViewModel.PaymentReceipt paymentRec = new smART.Library.PaymentReceiptLibrary(smART.Common.ConfigurationHelper.GetsmARTDBContextConnectionString()).GetByID(ID);
        ...
        {
            ViewBag.ID = ID;
            smART.ViewModel.Invoice invoice = new smART.Library.InvoiceLibrary(smART.Common.ConfigurationHelper.GetsmARTDBContextConnectionString()).GetByID(ID);
        ...
        private string GetFilterViewByFocusArea(string focusArea, string subFocusArea)
        {
            switch (focusArea)
            {
                ...
                case "Tickets":
                    ...
                    else if (subFocusArea == "Today's Receiving Tickets")
                        return "ScaleReceivingReportFilter";
                    else if (subFocusArea == "Shipping Scale Tickets")
                        return "ScaleShippingReportFilter";
                    else if (subFocusArea == "Today's Shipping Tickets")
                        return "ReportFilter";
