...
{
    public partial class ScaleLocalSalesTicket : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string rptName = "/Content/Reports/ScaleLocalSalesTicket.rdl";
                ...
                ReportDataSource datasource = new ReportDataSource("dsScaleShpping", conRCM);
