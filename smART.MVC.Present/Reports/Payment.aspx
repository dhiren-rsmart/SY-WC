<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="smART.MVC.Present.Reports.Payment" %>
    ...
    <div style = "height:11in; width:8.5in;" >     
     <asp:ScriptManager ID="ScriptManager1" runat="server"/>    
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smARTDBContext %>"
            SelectCommand="SPRP_Check" SelectCommandType="StoredProcedure">
            <SelectParameters>
       ...
       <rsweb:ReportViewer ID="rptViewer" runat="server" Font-Names="Verdana" 
            ...
            Height="100%">
            <LocalReport ReportPath="/Content/Reports/Check.rdl">
                <DataSources>
