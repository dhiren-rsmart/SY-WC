<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScaleReceiveTicket.aspx.cs" Inherits="smART.MVC.Present.Reports.ScaleReceiveTicket" %>
...
<body>
    ...
    <div style = "height:11in; width:8.5in;" > 
        ...
        <asp:SqlDataSource ID="conRCM" runat="server" 
            ConnectionString="<%$ ConnectionStrings:smARTDBContext %>" SelectCommand="SPRP_Scale_Receive" 
    ...
    <LocalReport ReportPath="/Content/Reports/ScaleReceiveTicket.rdl"  >
    <DataSources >
